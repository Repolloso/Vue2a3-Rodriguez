...
<script lang="js">
  ...
  export default  {
    ...
    methods: {
      ...
      async SendData () {
        // ! Guardo en un objeto los datos ingresados
        let data = {
          name: this.name,
          email: this.email,
        ...
        let response = await axios.post("https://62d8b1a29088313935937e1f.mockapi.io/api/users", data);
        // ! Si la respuesta es correcta, redirijo a la pagina de login, guardo en usuarios(login) el usuario que se registro
